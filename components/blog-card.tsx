...
import { formatDateShort, getReadingTimeText } from '@/lib/utils'
...
export function BlogCard({ post }: BlogCardProps) {
  return (
    <Card className="group overflow-hidden border-0 shadow-card hover:shadow-primary/20 transition-all duration-500 hover:-translate-y-2">
